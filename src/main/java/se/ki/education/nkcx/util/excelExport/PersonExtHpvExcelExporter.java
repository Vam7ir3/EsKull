...
public class PersonExtHpvExcelExporter {

    public Workbook exportToExcel(List<PersonExtHpvRes> dataList) {
        ...
        int rowNum = 1;
        for (PersonExtHpvRes data : dataList) {
            ...
            // Extract hpv Name
            String extHpvName = (data.getExtHpvRes() != null)
                    ? data.getExtHpvRes().getName()
                    : "";
            dataRow.createCell(1).setCellValue(extHpvName);
        }
